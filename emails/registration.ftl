...
<table style="padding:0 4px 0 4px">
    ...
    <tr>
        <td style="padding-top: 8px; padding-left: 10px; padding-right: 1=0px;">
            This message is to confirm that the CityHub account with the name <span style="font-weight:bold;">${email}</span> belongs to you. After verification, we will be ready to activate your account.
    </tr>
    <tr>
